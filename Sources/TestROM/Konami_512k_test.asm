; Example to create an MegaRom of 512kB that use an Konami K6 Mapper
; for Sjasm assembler
...
Seg_P6000_SW:	equ	06000h	; Segment switch for page 6000h-7FFFh (Konami 8k Mapper)
Seg_P8000_SW:	equ	08000h	; Segment switch for page 8000h-9FFFh (Konami 8k Mapper)	
Seg_PA000_SW:	equ	0A000h	; Segment switch for page A000h-BFFFh (Konami 8k Mapper)
PosText1:       equ	06000h	; 	
PosText2:       equ	08000h	; 	
PosText3:       equ	0A000h	; 		
...
asc_test_string:
	db "Konami without SCC 512KB test",LF,CR,LF,CR,0
